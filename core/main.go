...
// Growl Makes the rabbit growl
// The rabbit must know how.  So one has
// to manually  intialize the struct.  The rabbit will try to create
//  exchange, queue and bind it to the exchange
//Example:
//q.Name = "events"
//q.RK = "#"
